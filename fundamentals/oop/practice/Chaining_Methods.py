...
##user2
user2.make_deposit(500).make_deposit(200).make_withdrawal(500).make_withdrawal(100)
##user3
user3.make_deposit(1000).make_withdrawal(700).make_withdrawal(100).make_withdrawal(100)
##display1
